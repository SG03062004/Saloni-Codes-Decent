...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Map<String, String>> handleNotFound(
      DeliveryService.DeliveryNotFoundException ex) {
    return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Map.of("error", ex.getMessage()));
  }

  @ExceptionHandler(DeliveryService.InvalidStatusTransitionException.class)
  public ResponseEntity<Map<String, String>> handleBadTransition(
      DeliveryService.InvalidStatusTransitionException ex) {
