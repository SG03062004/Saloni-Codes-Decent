...
class OrderControllerIntegrationTest {
  ...
  void postOrder_persistsRowAndPublishesToKafka() throws Exception {
    var body =
        Map.of(
            ...
            "rest-xyz",
            "items",
            List.of(Map.of("menuItemId", "item-1", "quantity", 2, "unitPriceCents", 1500)),
            "deliveryAddress",
            Map.of("lat", 37.77, "lng", -122.41, "street", "1 Market St", "city", "San Francisco"));
  ...
  void postOrder_returns400ForMissingFields() throws Exception {
    mockMvc
        .perform(post("/orders").contentType(MediaType.APPLICATION_JSON).content("{}"))
