...
from app.logging_config import get_logger, set_order_id
...
async def metrics_middleware(request: Request, call_next):
    set_order_id(request.headers.get("x-order-id"))
...
def predict(body: EtaRequest):
    ...
    log.info(
        "predict-eta response", extra={**extra, "estimated_delivery_minutes": result}
    )
